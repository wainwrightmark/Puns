...
public static class Helpers
{
    ...
    /// </summary>
    public static IReadOnlyDictionary<PartOfSpeech, IReadOnlyDictionary<string, SynSetRelation>>
        PartOfSpeechSymbolRelationDictionary { get; } = CreatePosSymbolRelationDictionary();

    /// <summary>
    /// Static constructor
    /// </summary>
    private static IReadOnlyDictionary<PartOfSpeech, IReadOnlyDictionary<string, SynSetRelation>>
        CreatePosSymbolRelationDictionary()
    {
